...
| **B · Lo abro el lunes**        | Vista «Esta semana» (§13), panel de avance (§12), calendario, marcar actividad como hecha                        | 3-4 días    |
| **C · Mi equipo lo usa**        | Supabase, cuentas, roles (§17), resolución de conflictos, historial (§30)                                        | 1-2 semanas |

A y B suman semana y media y son los que convierten esto en algo utilizable. C es donde
...
Las 157 pruebas y las reglas de arquitectura que el CI hace cumplir no son burocracia:
